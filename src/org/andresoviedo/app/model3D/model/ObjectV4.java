...
//		                    "  diffuse = 1.0;"+
	...
	public ObjectV4(float[] objCoords, float[] vertexColors, short[] drawOrder, float[] vNormals, float[] textCoord,
			int drawType, int drawSize, List<InputStream> open) {
	 ...
	 * @param vertices
	 */
	public ObjectV4(FloatBuffer objCoords, FloatBuffer vertexColors, ShortBuffer drawOrder, FloatBuffer normalsBuffer,
			FloatBuffer textureCoords, int drawMode, int drawSize, List<InputStream> textureIs) {
	...
	public void drawBoundingBox(float[] mvpMatrix, float[] mvMatrix) {
		if (boundingBox == null) {
			...
			boundingBoxObject = new ObjectV4(boundingBox.getVertices(), boundingBox.getColors(),
		...
		boundingBoxObject.draw(mvpMatrix, mvMatrix, boundingBox.getDrawMode(), boundingBox.getDrawSize());
