...
class BoundingBox {
	 ...
	 */
	public BoundingBox(org.andresoviedo.android_3d_model_engine.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(org.andresoviedo.android_3d_model_engine.entities.BoundingBox box) {
		//@formatter:off
