package org.the3deers.polybool.demo;
...
import static org.andresoviedo.dddmodel2.R.id;
...
public class WebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final WebView myWebView = (WebView) findViewById(id.webView);
        ...
        //myWebView.loadUrl("https://rawgit.com/voidqk/polybooljs/master/dist/demo.html");        // Original PolyBool code (web) - Demo 100% Web
