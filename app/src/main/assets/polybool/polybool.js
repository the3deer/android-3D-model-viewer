...
PolyBool = {
	...
	combine: function(segments1, segments2){
		...
		Android.logd(JSON.stringify(segments1));
    	Android.logd(JSON.stringify(segments2));
...
function operate(poly1, poly2, selector){
    Android.logd(JSON.stringify(poly1));
    Android.logd(JSON.stringify(poly2));
	var seg1 = PolyBool.segments(poly1);
	Android.logd(JSON.stringify(buildLog));
	var seg2 = PolyBool.segments(poly2);
	var comb = PolyBool.combine(seg1, seg2);
	var seg3 = selector(comb);
    	var ret = PolyBool.polygon(seg3);
    	Android.logd("--------------------------------------------");
            	Android.logd(JSONstringifyOrder(buildLog));
            	Android.logd("--------------------------------------------");
	return ret;
}
